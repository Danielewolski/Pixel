...
const leg = [
    ...
    { pokemon: 'Glastrier', biomes: 'snowy_taiga_mountains, snowy_coniferous_clearing, frozen_ocean, snowy_deciduous_forest, snowy_coniferous_forest, snowy_evergreen_taiga, snowy_deciduous_clearing, lush_tundra, ice_spikes, snowy_coniferous_forest_hills, snowy_taiga_hills, snowy_beach, snowy_tundra, frozen_river, shattered_glacier, snowy_blue_taiga_hills, snowy_blue_taiga, frozen_lake, snowy_deciduous_forest_hills, snowy_taiga, northern_forest, snowy_evergreen_hills, snowy_evergreen_clearing, snowy_blue_giant_taiga, snowy_mountains', time: 'Day', others: '//', catchrate: '3%' },
    ...
    { pokemon: 'Marshadow', biomes: 'sythian_torrids, embur_bog, magna_wastes, withering_woods, wailing_garth, glowstone_gardens, nether_wastes, basalt_deltas, soul_sand_valley, warped_forest, warped_desert, weeping_mire, quartz_desert, subzero_hypogeal, crimson_forest, badlands_plateu, crimson_gardens, brimstone_caverns', time: 'Night', others: '//', catchrate: '3%' },
    ...
    { pokemon: 'Mesprit', biomes: 'aspen_forest_hills, oasis, tall_birch_forest, great_lakes, aspen_clearing, aspen_forest, birch_forest, great_lake_isles, seasonal_birch_forest, desert_lakes, fresh_water_lake, birch_forest_hills, seasonal_birch_forest_hills, tall_birch_hills', time: 'Dawn, Morning', others: '//', catchrate: '3%' },
    ...
    { pokemon: 'Phione', biomes: '//', time: '//', others: 'Manaphy breeding', catchrate: '30%' },
